"""
Модуль переводов для настольного приложения A/B тестирования.
...
TRANSLATIONS = {
    'en': {
        ...
        'comparison_title': 'COMPARISON OF ONE-SIDED AND TWO-SIDED TESTS',
        'one_sided_tests_title': 'ONE-SIDED TESTS (new > old)',
        'two_sided_tests_title': 'TWO-SIDED TESTS (any difference)',
        'simulation_p_value': 'Simulation p-value: {}',
        'z_test_p_value': 'Z-test p-value: {}',
        'z_score': 'Z-score: {}',
        'success_message': 'SUCCESS: Two-sided tests achieved p-value < {}!',
        'statistically_significant_difference': 'This shows a statistically significant difference between old and new pages when testing for any difference.',

        # A/B Test page - Interpretation
        'interpretation_title': 'INTERPRETATION:',
        'interpretation_one_sided_check': '- One-sided tests check whether the new page is BETTER than the old one',
        'interpretation_two_sided_check': '- Two-sided tests check for ANY difference between pages',
        'interpretation_two_sided_more_likely': '- Two-sided tests are more likely to detect significant differences',
        'interpretation_one_sided_prove_improvement': '- Use a one-sided test when you specifically want to prove improvement',
        'interpretation_two_sided_detect_difference': '- Use a two-sided test when you want to detect any difference',
...
def t(key, *args):
    """Получить перевод для ключа с опциональным форматированием."""
...
def switch_language(language):
    """Переключить язык приложения. Возвращает True при успехе."""
